...
const GLOW_COLOR = { base: 0, spread: 200 };
...
const GlowCard: React.FC<GlowCardProps> = ({ 
  ...
  useEffect(() => {
    ...
    const handleEnter = () => card.setAttribute('data-glow-active', '');
    const handleLeave = () => card.removeAttribute('data-glow-active');
